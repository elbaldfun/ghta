...
1. **语料阈值**:三榜 N=20k/10k/5k(稳态 2–4 万条)——可接受?还是先更保守(如 10k/5k/3k)试水?
2. **导航位置**:确认放 AI ▾ 下拉内(不新增顶级项)?
3. **默认排序**:`hot`(likes 增速,速度是主角)还是 `downloads`(当前采用,更直觉)?我倾向 hot,与全站一致。
4. **v1 是否顺带数据集榜**:我建议不带(§8),但如果你觉得"模型+数据集"一起才完整,工作量约 +30%。
